  ...
  await firestore
    ...
    .then(async (querySnapshot) => {
      for (var doc of querySnapshot.docs) {
        console.log(`Deleting document ${doc.id} from collection user_answers`);
        await doc.ref.delete();
      }
    });
  await firestore
    ...
    .then(async (querySnapshot) => {
      for (var doc of querySnapshot.docs) {
        console.log(`Deleting document ${doc.id} from collection lessons`);
        await doc.ref.delete();
      }
    });
  await firestore
    ...
    .then(async (querySnapshot) => {
      for (var doc of querySnapshot.docs) {
        console.log(`Deleting document ${doc.id} from collection levels`);
        await doc.ref.delete();
      }
    });
});
